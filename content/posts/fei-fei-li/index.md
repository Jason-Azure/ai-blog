...
Karpathy 出生在斯洛伐克,在加拿大长大。和李飞飞一样,也是移民的孩子。他的研究方向是把视觉和语言连起来——让机器不只"看见"一张图片,还能用自然语言**描述**它看见了什么。这个方向今天叫做"图文理解",是多模态 AI 的根基之一。而在当时,这还是一个小众的、不那么被看好的课题。
...
2015 年,加入 OpenAI,成为创始成员之一。2017 年,去了特斯拉,担任 AI 总监,主导了 FSD(全自动驾驶)的核心视觉系统——把摄像头拍到的画面变成驾驶决策。这件事的本质,和他博士期间做的事是同一件:让机器**看懂**它看到的东西。
